...
RESULT_DIR = Path(
    r"D:\Projects\ai-nids\results\cnn_torch"
)
...
def main():
    ...
    if SAMPLE_SIZE is not None and SAMPLE_SIZE < len(df):
        print(f"正在采样 {SAMPLE_SIZE} 条数据用于 PyTorch CNN 训练...")
    ...
    print("开始训练 PyTorch CNN with Early Stopping...")
    ...
    result_text = f"""PyTorch CNN Binary Classification Baseline with Early Stopping
...
"""
    ...
    report_path = RESULT_DIR / "cnn_torch_binary_report.txt"
    metrics_csv_path = RESULT_DIR / "cnn_torch_binary_metrics.csv"
    metrics_png_path = RESULT_DIR / "cnn_torch_binary_metrics.png"
    cm_png_path = RESULT_DIR / "cnn_torch_binary_confusion_matrix.png"
    loss_png_path = RESULT_DIR / "cnn_torch_training_loss.png"
    ...
    plt.ylim(0.0, 1.05)
    plt.title("PyTorch CNN Binary Classification Metrics")
    plt.ylabel("Score")
