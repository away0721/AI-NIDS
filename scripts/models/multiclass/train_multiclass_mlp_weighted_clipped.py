...
RESULT_DIR = Path(r"D:\Projects\ai-nids\results\multiclass\mlp_torch_weighted_clipped")
MODEL_PATH = Path(
    r"D:\Projects\ai-nids\models\multiclass\mlp_torch_weighted_clipped_multiclass.pt"
)
SCALER_PATH = Path(
    r"D:\Projects\ai-nids\models\multiclass\mlp_torch_weighted_clipped_multiclass_scaler.pkl"
)
LABEL_ENCODER_PATH = Path(
    r"D:\Projects\ai-nids\models\multiclass\mlp_torch_weighted_clipped_label_encoder.pkl"
)

REPORT_PATH = RESULT_DIR / "mlp_torch_weighted_clipped_multiclass_report.txt"
METRICS_CSV_PATH = RESULT_DIR / "mlp_torch_weighted_clipped_multiclass_metrics.csv"
METRICS_FIG_PATH = RESULT_DIR / "mlp_torch_weighted_clipped_multiclass_metrics.png"
CONFUSION_MATRIX_FIG_PATH = (
    RESULT_DIR / "mlp_torch_weighted_clipped_multiclass_confusion_matrix.png"
)
TRAINING_HISTORY_CSV_PATH = (
    RESULT_DIR / "mlp_torch_weighted_clipped_multiclass_training_history.csv"
)
TRAINING_HISTORY_FIG_PATH = (
    RESULT_DIR / "mlp_torch_weighted_clipped_multiclass_training_history.png"
)
...
def main() -> None:
    ...
    # 限制类别权重的最大值，避免 Heartbleed / Infiltration 这类极少数类权重过大
