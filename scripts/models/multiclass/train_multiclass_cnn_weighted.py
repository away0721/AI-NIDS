...
RESULT_DIR = Path(r"D:\Projects\ai-nids\results\multiclass\cnn_torch_weighted")
MODEL_PATH = Path(
    r"D:\Projects\ai-nids\models\multiclass\cnn_torch_weighted_multiclass.pt"
)
SCALER_PATH = Path(
    r"D:\Projects\ai-nids\models\multiclass\cnn_torch_weighted_multiclass_scaler.pkl"
)
LABEL_ENCODER_PATH = Path(
    r"D:\Projects\ai-nids\models\multiclass\cnn_torch_weighted_label_encoder.pkl"
)

REPORT_PATH = RESULT_DIR / "cnn_torch_weighted_multiclass_report.txt"
METRICS_CSV_PATH = RESULT_DIR / "cnn_torch_weighted_multiclass_metrics.csv"
METRICS_FIG_PATH = RESULT_DIR / "cnn_torch_weighted_multiclass_metrics.png"
CONFUSION_MATRIX_FIG_PATH = RESULT_DIR / "cnn_torch_weighted_multiclass_confusion_matrix.png"
TRAINING_HISTORY_CSV_PATH = RESULT_DIR / "cnn_torch_weighted_multiclass_training_history.csv"
TRAINING_HISTORY_FIG_PATH = RESULT_DIR / "cnn_torch_weighted_multiclass_training_history.png"
...
def plot_metrics(metrics: dict) -> None:
    ...
    plt.ylim(0, 1)
    plt.title("Weighted PyTorch CNN Multiclass Metrics")
    plt.ylabel("Score")
...
def plot_confusion_matrix(cm, class_names) -> None:
    ...
    plt.imshow(cm)
    plt.title("Weighted PyTorch CNN Multiclass Confusion Matrix")
...
def plot_training_history(history_df: pd.DataFrame) -> None:
    ...
    plt.title("Weighted PyTorch CNN Multiclass Training History")
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.legend()
    plt.tight_layout()
...
def main() -> None:
    ...
    with open(REPORT_PATH, "w", encoding="utf-8") as file:
        file.write("Weighted PyTorch CNN Multiclass Classification Report\n")
        file.write("=" * 60 + "\n\n")
