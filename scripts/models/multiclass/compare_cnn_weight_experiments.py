...
OUTPUT_DIR = RESULT_ROOT / "cnn_weight_experiments"
OUTPUT_CSV_PATH = OUTPUT_DIR / "cnn_weight_experiments_comparison.csv"
OUTPUT_FIG_PATH = OUTPUT_DIR / "cnn_weight_experiments_comparison.png"
...
def plot_comparison(comparison_df: pd.DataFrame) -> None:
    ...
    plt.title("CNN Weight Experiment Comparison")
    plt.ylabel("Score")
    plt.ylim(0, 1)
