...
MODEL_METRICS_FILES = {
    ...
    "CNN": RESULT_ROOT / "cnn_torch" / "cnn_torch_multiclass_metrics.csv",
    "Weighted CNN": RESULT_ROOT
    / "cnn_torch_weighted"
    / "cnn_torch_weighted_multiclass_metrics.csv",
    "Clipped Weighted CNN": RESULT_ROOT
    / "cnn_torch_weighted_clipped"
    / "cnn_torch_weighted_clipped_multiclass_metrics.csv",
}

OUTPUT_DIR = RESULT_ROOT / "deep_learning_weight_experiments"
OUTPUT_CSV_PATH = OUTPUT_DIR / "deep_learning_weight_experiments_comparison.csv"
OUTPUT_FIG_PATH = OUTPUT_DIR / "deep_learning_weight_experiments_comparison.png"
...
def plot_comparison(comparison_df: pd.DataFrame) -> None:
    ...
    plt.title("Deep Learning Weight Experiment Comparison")
    plt.ylabel("Score")
    plt.ylim(0, 1)
