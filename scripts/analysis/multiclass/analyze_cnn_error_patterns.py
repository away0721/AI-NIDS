...
RESULT_DIR = Path(r"D:\Projects\ai-nids\results\multiclass\cnn_error_patterns")

ERROR_DETAIL_CSV_PATH = RESULT_DIR / "cnn_error_details.csv"
ERROR_PATTERN_CSV_PATH = RESULT_DIR / "cnn_error_pattern_summary.csv"
ERROR_PATTERN_FIG_PATH = RESULT_DIR / "cnn_top_error_patterns.png"
ATTACK_TO_BENIGN_CSV_PATH = RESULT_DIR / "cnn_attack_to_benign_errors.csv"
BENIGN_TO_ATTACK_CSV_PATH = RESULT_DIR / "cnn_benign_to_attack_errors.csv"
...
def plot_top_error_patterns(error_pattern_df: pd.DataFrame) -> None:
    ...
    plt.title("Top CNN Error Patterns")
...
def main() -> None:
    ...
    # 这里不需要训练集和验证集，只是为了保证 test set 与训练脚本一致。
